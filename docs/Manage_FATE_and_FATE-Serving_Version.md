...
```
$ kubefate chart upload -f ./fate-v1.11.1.tgz
Upload file success

$ kubefate chart ls
UUID                                    NAME    VERSION        APPVERSION
ca3f7843-749a-4f69-9f6b-4c544a7623ac    fate    v1.11.1         v1.11.1
```

Then, we can deploy the fate cluster of v1.11.1 version. The detail of cluster.yaml please refer to: [FATE Cluster Configuration](./configurations/FATE_cluster_configuration.md)
```
chartName: fate

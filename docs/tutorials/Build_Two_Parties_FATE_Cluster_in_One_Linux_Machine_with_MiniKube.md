...
```
export fate_version=v1.11.1 && export kubefate_version=v1.4.5 && cd ~ && mkdir demo && cd demo
```
...
* When talking about KubeFATE version, usually there are 3 notions:
   ...
   * The FATE version, in this tutorial, it is v1.11.1, it also means the version of the helm chart of FATE, currently we use this version to tag the KubeFATE GitHub master branch.
...
pack, which is `v1.11.1` as set to ENVs before. (replace ${fate_version} with the newest version available)
```
...
29878fa9-aeee-4ae5-a5b7-fd4e9eb7c1c3    fate-9999       fate-9999       1               Running fate    v1.11.1          88s
dacc0549-b9fc-463f-837a-4e7316db2537    fate-10000      fate-10000      1               Running fate    v1.11.1          69s
```

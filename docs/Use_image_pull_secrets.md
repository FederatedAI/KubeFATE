...
This solution can be used in both [Dockerhub](https://hub.docker.com/) or other private/public image repositories/registries. The following example takes Dockerhub as an example,
```bash
